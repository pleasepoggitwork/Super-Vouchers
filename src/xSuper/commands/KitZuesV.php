...
class KitZuesV extends BaseCommand
{
    /** @var RankV */
    private $plugin;
        ...
        if ($sender->hasPermission("rankv.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::AQUA . "Zues Kit" . TextFormat::BOLD . TextFormat::WHITE . " Voucher");
                    $lore = [
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("zuesv", 1);
                ...
                $sender->sendMessage("Usage: /zuesv <player>");
            }
        } else {

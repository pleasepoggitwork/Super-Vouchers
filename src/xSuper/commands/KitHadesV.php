...
class KitHadesV extends BaseCommand
{
    /** @var RankV */
    private $plugin;
        ...
        if ($sender->hasPermission("rankv.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::RED . "Hades Kit" . TextFormat::BOLD . TextFormat::WHITE . " Voucher");
                    $lore = [
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("hadesv", 1);
                ...
                $sender->sendMessage("Usage: /hadesv <player>");
            }
        } else {

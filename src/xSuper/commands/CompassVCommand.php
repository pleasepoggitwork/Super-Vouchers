...
class CompassVCommand extends BaseCommand
{
    /** @var RankV */
    private $plugin;
        ...
        if ($sender->hasPermission("rankv.command.use")) {
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $item->setCustomName(TextFormat::BOLD . TextFormat::YELLOW . "Compass Command" . TextFormat::BOLD . TextFormat::WHITE . " Voucher");
                    $lore = [
                    ...
                    $item->setLore($lore);
                    $item->getNamedTag()->setInt("compassv", 1);
                ...
                $sender->sendMessage("Usage: /compassv <player>");
            }
        } else {

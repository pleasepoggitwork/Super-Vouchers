            ...
            if (count($args) === 1) {
                ...
                if ($target instanceof Player) {
                    ...
                    $lore = [
                        ...
                        TextFormat::RESET .TextFormat::WHITE . "* 25x Cave Spider Spawner",
                        TextFormat::WHITE . "* 25x Enderman Spawner",
                        TextFormat::WHITE . "* 25x Blaze Spawner",
                        TextFormat::WHITE . "* 25x Guardian Spawner",
                        " ",
